(* OASIS_START *)
(* DO NOT EDIT (digest: 572b583d381ec309cf41d96ec50c734f) *)
...
let package_default =
  {
     ...
     flags =
       [
          (["oasis_library_nanomsg_ccopt"; "compile"],
            [
               (OASISExpr.EBool true,
                 S [A "-ccopt"; A "-I"; A "-ccopt"; A "${pkg_ctypes_stubs}"])
            ]);
          (["oasis_library_nanomsg_cclib"; "link"],
            [(OASISExpr.EBool true, S [A "-cclib"; A "-lnanomsg"])]);
          (["oasis_library_nanomsg_cclib"; "ocamlmklib"; "c"],
            [(OASISExpr.EBool true, S [A "-lnanomsg"])])
       ];
